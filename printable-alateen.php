...
<body>
      ...
      <strong> <font color="#000000" size="3" face="Arial, Helvetica, sans-serif">Georgia 
      All Alateen Meetings by </font><font face="Arial, Helvetica, sans-serif" color="#000000">City</font></strong> 
      <p> <font color="#000000" size="1" face="Arial, Helvetica, sans-serif">Note: 
        * designates that an AA group meets at the same time</font><font color="#0033FF" size="1" face="Arial, Helvetica, sans-serif"><font color="#FF0000"></font></font></p>
      <p>&nbsp;</p>
            <table cellSpacing="1" border="0" id="table3">
			 ...
			 <?php
				...
				$results = mysql_query($sql) or die("Failed");
