...
<header>
	<div id="navbarpmb" class="navbar navbar-default navbar-fixed-top navbar-inverse" >
		<div class="container">
...
<div class = "container">
	...
	<a href="/index.html" class = "navbar-brand"><img src="images/50_years-100px.png" class="img-responsive" alt="GA Al-Anon"></a>
	<div class = "jumbotron">
		<img src="/images/Ga_Al-Anon_Logo.gif" alt="Georgia Al-Anon Hope and help for families and friends of alcoholics"  class="img-responsive">
		<h1>Georgia Al-Anon / Alateen Meetings</h1>
	...
	<div class = "row"><!-- Table Header -->
		...
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-4">
			Group Name
			<span class="visible-sm visible-xs">Meeting day &amp; time</span>
		</div>
...
foreach($daytime as $k => $x)	{
	...
	<div class = "row">
		...
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-4">
			...
			<span class="visible-sm visible-xs"><?php echo $dow[substr($k,0,1)] . " " . $mtime; ; //day?></span>
		</div>
		<div class="col-lg-2 col-md-2 visible-md visible-lg">
			<!-- Meeting day &amp; time -->
		...
		<div class="col-lg-3 col-xs-3">
			<!--  Meeting place -->
			<?php echo $meetingrecord[$x]["place"]; ?><br \>

			<!-- Street Address -->
			<?php echo $meetingrecord[$x]["address"]; ?><br \>
